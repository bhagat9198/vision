...
export default function VariableEventPage({ params }: { params: Promise<{ photographerSlug: string; slug: string[] }> }) {
    const { photographerSlug, slug } = use(params);
    ...
    // Construct the full slug using photographerSlug and eventSlugParts
    const fullSlug = `${photographerSlug}/${eventSlugParts.join('/')}`;
